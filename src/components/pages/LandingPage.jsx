    ...
    <div className="huertohogar-page">
      <section className="hero">
        <div className="hero-content">
          ...
          <p id="heroSubtitle">Empieza tus compras con nosotros a partir de hoy.</p>
      ...
      <section className="contexto-section container">
        ...
        <p>
          ...
          en Chile. Contamos con más de 6 años de experiencia en más de 9 puntos
          del país.
        </p>
        <p>
          Nuestro objetivo es conectar a las familias con el campo, promoviendo un
      ...
      <section className="mision-vision-section container">
        <div className="mision">
          ...
          <p>
            ...
            fomentando una conexión entre consumidores y agricultores locales.
          </p>
        </div>
        ...
        <div className="vision">
          <h3>🍃 Visión</h3>
          <p>
            Ser la tienda online líder en productos frescos en Chile, reconocida por
